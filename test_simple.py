...
def parse_args():
    ...
    parser.add_argument('--model_name',
                        ...
                        choices=[
                            ...
                            "stereo_no_pt_640x192", "mono+stereo_no_pt_640x192",
                            "mono_1024x320", "stereo_1024x320",
...
def test_simple(args):
    ...
    if os.path.isfile(args.image_path):
        ...
        out_dir_npy = output_directory
        out_dir_jpeg = output_directory
    elif os.path.isdir(args.image_path):
        # Searching folder for images
        paths = glob.glob(os.path.join(args.image_path,
                                       '*.{}'.format(args.ext)))
        output_directory = args.image_path.rstrip('/').rsplit('/', 1)[0]
        out_dir_npy = os.path.join(output_directory, 'disp')
        out_dir_jpeg = os.path.join(output_directory, 'disp_jpeg')
    else:
    ...
    with torch.no_grad():
        for idx, image_path in enumerate(paths):
            ...
            name_dest_npy = os.path.join(out_dir_npy,
            ...
            name_dest_im = os.path.join(out_dir_jpeg,
